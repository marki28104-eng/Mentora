...
ANALYTICS_MODEL_RETRAIN_INTERVAL_HOURS = int(os.getenv("ANALYTICS_MODEL_RETRAIN_INTERVAL_HOURS", "24"))
ANALYTICS_SESSION_CLEANUP_INTERVAL_HOURS = int(os.getenv("ANALYTICS_SESSION_CLEANUP_INTERVAL_HOURS", "24"))
ANALYTICS_MIN_DATA_POINTS_FOR_TRAINING = int(os.getenv("ANALYTICS_MIN_DATA_POINTS_FOR_TRAINING", "50"))
ANALYTICS_ENABLE_REAL_TIME_PERSONALIZATION = os.getenv("ANALYTICS_ENABLE_REAL_TIME_PERSONALIZATION", "true").lower() == "true"
ANALYTICS_ENABLE_PREDICTIVE_MODELS = os.getenv("ANALYTICS_ENABLE_PREDICTIVE_MODELS", "true").lower() == "true"
ANALYTICS_ENABLE_COHORT_ANALYSIS = os.getenv("ANALYTICS_ENABLE_COHORT_ANALYSIS", "true").lower() == "true"